        ...
        <div class="card">
            ...
            <form id="form-daftar">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="nisn">NISN* (Klik disini untuk <a target="https://nisn.data.kemdikbud.go.id/" href="https://nisn.data.kemdikbud.go.id/">Cek NISN </a>)</label>
                    ...
                    <div class="form-group">
                        <label for="asal">PROGRAM MADRASAH</label>
                    ...
                    <div class="form-group">
                        <label for="asal">ASAL SEKOLAH/MADRASAH</label>
                    ...
                    <div class="form-group">
                        <label for="nohp">NO HANDPHONE/WHATSHAPP (diisi untuk info dan konfirmasi)</label>
