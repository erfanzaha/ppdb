                ...
                <ul class="list-unstyled user-details list-unstyled-border list-unstyled-noborder">
                    <li class="media">
                        ...
                        <div class="media-body">
                            <div class="media-title">Maksum Harahap, S.Sos.I</div>
                            <div class="text-job text-muted"></i>081375245172</div>
                        </div>
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                            <div class="media-title">Ihsan Irfandi Pakpahan, S.Pd</div>
                            <div class="text-job text-muted"></i>081375479499</div>
                        </div>
