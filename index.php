        ...
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Login Admin</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">

                            <a href="https://ppdb.mtssypalazhar.sch.id/admin" data-id="login" class=" klikmenu dropdown-item has-icon ">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; <?= date('Y') ?> PPDB MTSS YP. AL-AZHAR <div class="bullet"></div>
                </div>
